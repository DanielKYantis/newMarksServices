...
<main class="main">
    ...
    <section id="about" class="about section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="metric-list">
                  <div class="metric-row">
                    <div class="metric-value">
                      <span data-purecounter-start="0" data-purecounter-end="Local" data-purecounter-duration="0" class="purecounter">Local</span>
                    </div>
                    <div class="metric-detail">
                      <h5>Home Repair Focus</h5>
                      <p>Plumbing, electrical, water systems, carpentry, and maintenance</p>
                    </div>
                  </div>

                  <div class="metric-row">
                    <div class="metric-value">
                      <span data-purecounter-start="0" data-purecounter-end="Clear" data-purecounter-duration="0" class="purecounter">Clear</span><span class="unit">%</span>
                    </div>
                    <div class="metric-detail">
                  ...
                  <div class="metric-row">
                    <div class="metric-value">
                      <span data-purecounter-start="0" data-purecounter-end="Core" data-purecounter-duration="0" class="purecounter">Core</span><span class="unit">+</span>
                    </div>
                    <div class="metric-detail">
        ...
        </div><!-- End Pillar Block -->

        <div class="specialty-block">
          <div class="row align-items-end g-3 specialty-heading" data-aos="fade-up" data-aos-delay="100">
            <div class="col-lg-7">
              <span class="eyebrow-label">Service Groups</span>
